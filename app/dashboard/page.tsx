...
function formatPaymentType(subscription: SubscriptionManagement) {
  if (subscription.type === "one_time") return humanize(subscription.payment_method_details?.method || subscription.payment_channel) || "One time";
  return humanize(subscription.payment_method_details?.brand || subscription.payment_channel) || "Recurring";
}
