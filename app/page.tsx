import { MenuOutline, Play } from "ionicons/icons";
      ...
      <section id="about" className="stream-section">
        ...
        <div className="stream-inner">
          <div className="stream-intro">
            <h2>Elevate your Stream with individually Tailored <span>AI Voices</span></h2>
            <div className="stream-description">
              <p>EchoStream gives your audience a voice that feels like part of the stream. Turn live messages into natural, expressive speech without breaking the flow of your content.</p>
              <p>Choose voices that match your style, keep your community engaged, and make every interaction feel more personal from the first message to the last.</p>
            </div>
          </div>
          <div className="stream-video-wrap">
            <div className="stream-video">
              <img src="/streamer.jpg" alt="Streamer speaking into a microphone while wearing a headset" />
              <div className="stream-video-overlay" />
              <button className="stream-play" type="button" aria-label="Play EchoStream introduction"><IonIcon icon={Play} aria-hidden="true" /></button>
            </div>
            <div className="stream-video-footer">
              <p>Interested to see more?</p>
              <a href="#features" className="find-out-more">Find out more <span>↗</span></a>
            </div>
          </div>
        </div>
      </section>
